...
{
    public static class CustomAdminJwtAuthenticationExtension
    {
        public static IServiceCollection AddCustomAdminJwtAuthentication(this IServiceCollection services, AppSettings appSettings)
        {
