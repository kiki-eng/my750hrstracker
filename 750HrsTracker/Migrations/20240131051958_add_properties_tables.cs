...
{
    public partial class add_properties_tables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyTeamUser", x => new { x.TeamId, x.UserId, x.PropertyId });
                    table.ForeignKey(
