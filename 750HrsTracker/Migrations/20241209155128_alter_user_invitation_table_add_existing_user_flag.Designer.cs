...
namespace _750HrsTracker.Migrations
{
    ...
    [Migration("20241209155128_alter_user_invitation_table_add_existing_user_flag")]
    partial class alter_user_invitation_table_add_existing_user_flag
    {
            ...
            modelBuilder.Entity("_750HrsTracker.Models.SubscriptionModels.Subscription", b =>
                {
                    ...
                    b.Property<string>("AndroidProductId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("IosProductId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("_750HrsTracker.Models.SubscriptionModels.SubscriptionTransactions", b =>
                {
                    ...
                    b.Property<bool>("IsCheckoutTransaction")
                        .HasColumnType("bit");

                    b.Property<bool>("IsMobileInAppPurchase")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("_750HrsTracker.Models.SubscriptionModels.SubscriptionTransactions", b =>
                {
                    ...
                    b.HasOne("_750HrsTracker.Models.SubscriptionModels.Subscription", "Subcription")
                        .WithMany()
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
